  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        {/* Hero Section */}
        <motion.section 
          className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-accent/5 py-20"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                ...
                5 Interactive Quizzes Available
              </motion.div>
              ...
              >
                Challenge yourself with engaging quizzes across Science, History, Geography, Astronomy, and Technology. Track your progress and compete on the leaderboard!
              </motion.p>
              ...
              >
                <Button 
                  asChild
                  size="lg"
                  className="px-8 py-4 bg-gradient-to-r from-primary to-[hsl(220,90%,55%)] text-primary-foreground rounded-lg font-semibold text-lg hover:shadow-lg hover:scale-105 transition-all"
                >
                  <a href="#quizzes" data-testid="start-quiz-hero">
                    Start Quiz
                ...
                >
                  <a href="#leaderboard" data-testid="view-leaderboard-hero">
                    View Leaderboard
                  </a>
                </Button>
              </motion.div>
              ...
              {/* Stats */}
              <motion.div 
                className="grid grid-cols-3 gap-6 max-w-2xl mx-auto mt-12 pt-12 border-t border-border"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-sm text-muted-foreground max-w-md">
                Interactive quiz platform to test and improve your knowledge across multiple categories. Built with React, Node.js, and PostgreSQL.
              </p>
            </div>
